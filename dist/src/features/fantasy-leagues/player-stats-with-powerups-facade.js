...
(function (PowerUpType) {
    PowerUpType["TripleCaptain"] = "Triple Captain";
    PowerUpType["DefensiveWall"] = "Defensive Wall";
    PowerUpType["MomentumBoost"] = "Momentum Boost";
    PowerUpType["PointMultiplier"] = "Point Multiplier";
    PowerUpType["DoublePoints"] = "Double Points";
    PowerUpType["BenchBoost"] = "Bench Boost";
 ...
 */
export function calculateUserTotalPointsWithPowerUps(userId, leagueId, gameweekId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const baseStats = yield calculateUserTeamStats(userId, gameweekId);
        // Get the power-ups used by this user in this league
        const membershipPowerUps = yield retrieveFantasyLeagueMembershipPowerUpsByLeagueIdAndUserId(leagueId, userId);
        ...
        if (team && team.captainId) {
            ...
            try {
                captainPoints = yield fetchPlayerPointsByGameweek(team.captainId, gameweekId);
