...
fantasyLeaguesApp.openapi(getFantasyLeagueByIdRoute, (c) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield pipe(safePrisma(() => env.prisma.fantasyLeague.findUnique({
        ...
        if (!league || league.status === 'failed')
...
fantasyLeaguesApp.openapi(validateTeamNameRoute, (c) => __awaiter(void 0, void 0, void 0, function* () {
    const env = c.get('env');
    ...
    const result = yield pipe(TE.tryCatch(() => __awaiter(void 0, void 0, void 0, function* () {
        // Determine League ID
        let targetLeagueId = leagueId;
        if (!targetLeagueId && code) {
            const league = yield env.prisma.fantasyLeague.findUnique({
                where: { code },
                select: { id: true }
            });
            if (league)
        ...
        const existing = yield env.prisma.fantasyLeagueMembership.findFirst({
            where: {
...
const joinFantasyLeagueRoute = createRoute({
    ...
    responses: {
        ...
        400: { description: 'Validation error or Duplicate Member' },
        409: { description: 'Conflict (e.g. League Full)' },
        500: { description: 'Internal Server Error' },
    },
    tags: ['Fantasy Leagues'],
});
