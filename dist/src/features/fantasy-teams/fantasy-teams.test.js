...
describe("Fantasy Teams", () => {
    describe("GET /", () => {
        ...
        test("given an unauthenticated user: it should return 200 (Public Route)", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe("POST /create-team", () => {
        test("given that a user selects 5 players for his team and all players costs are equal or under 35M pound: it should create a team for the user and map the players to the user", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test("given that a user selects 5 players for his team and the total cost of player is over 35M pounds: it should return an error stating that the total cost of players exceeds the budget", () => __awaiter(void 0, void 0, void 0, function* () {
            // Create a unique user for this test
            const user = yield saveUserToDatabase({
                id: `user-${Date.now()}-${Math.random()}`,
                email: `test-${Date.now()}-${Math.random()}@example.com`, // Unique email to avoid constraint violations
        ...
        test("given the user selects more than 2 players from the same team: it should return an error", () => __awaiter(void 0, void 0, void 0, function* () {
            // Create a unique user for this test
            const user = yield saveUserToDatabase({
                id: `user-${Date.now()}-${Math.random()}`,
                email: `test-${Date.now()}-${Math.random()}@example.com`,
