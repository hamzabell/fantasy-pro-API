...
solanaWebhookApp.openapi(solanaWebhookRoute, (c) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const rawBody = yield c.req.json().catch(() => null);
                                ...
                                switch (event.name) {
                                    ...
                                    case 'StakeEvent':
                                        ...
                                        if (stakedLeagueId && stakedUserId) {
                                            const membership = yield retrieveFantasyLeagueMembershipByLeagueAndUser(stakedLeagueId, stakedUserId);
                                            if (membership) {
                                    ...
                                    case 'PayoutEvent':
                                        ...
                                        const winnerUser = yield retrieveUserByWalletAddress(winnerPubkey);
                                        if (winnerUser && payoutLeagueId) {
                                            // Find membership
                                            const winnerMembership = yield retrieveFantasyLeagueMembershipByLeagueAndUser(payoutLeagueId, winnerUser.id);
                                            if (winnerMembership) {
                                                yield updateFantasyLeagueMembershipInDatabaseById({
                                    ...
                                    case 'PayoutCompletedEvent':
                                        ...
                                        if (finalLeagueId) {
                                            ...
                                            const updatedLosers = yield finalizeLeagueMemberships(finalLeagueId);
        ...
        rollbar.error('Error processing Solana webhook', error);
