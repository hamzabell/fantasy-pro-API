...
gameweekWebhookApp.openapi(gameweekStatusWebhookRoute, (c) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // Validate API token
        ...
        if (status === "started") {
            ...
            const updateResult = yield prisma.fantasyLeague.updateMany({
                where: {
            ...
            const stats = yield calculateAllLeagueWinners(gameweekId, {
...
gameweekWebhookApp.openapi(gameweekStatusRoute, (c) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // Validate API token
        const { authorization } = c.req.valid('header');
        const expectedToken = `Bearer ${process.env.WEBHOOK_API_TOKEN}`;
        ...
        const stats = yield getProcessingStats(gameweekId);
        return c.json(Object.assign({ gameweekId }, stats), 200);
    }
    catch (error) {
