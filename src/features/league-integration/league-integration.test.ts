...
describe('League Integration Routes', () => {
    ...
    test('GET /api/league-data/players should return players', async () => {
        ...
        const res = await app.request('/api/league-data/players?league=PREMIER_LEAGUE', {
            method: 'GET',
            headers: authHeaders
        });
    ...
    test('GET /api/league-data/players/{id} should return player by id', async () => {
        ...
        const res = await app.request('/api/league-data/players/1', {
            method: 'GET',
            headers: authHeaders
        });
    ...
    test('POST /api/league-data/players/ids should return players by ids', async () => {
        ...
        const res = await app.request('/api/league-data/players/ids', {
            method: 'POST',
    ...
    test('GET /api/league-data/teams/{id} should return team by id', async () => {
        ...
        const res = await app.request('/api/league-data/teams/1', {
            method: 'GET',
            headers: authHeaders
        });
    ...
    test('GET /api/league-data/gameweeks/future should return future gameweeks', async () => {
        ...
        const res = await app.request('/api/league-data/gameweeks/future', {
            method: 'GET',
            headers: authHeaders
        });
