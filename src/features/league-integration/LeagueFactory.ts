...
import type { ILeagueIntegrationService } from './LeagueIntegrationService.js';
import { PremierLeagueService } from './PremierLeagueService.js';

export class LeagueFactory {
    private static services: Map<RealLifeLeague, ILeagueIntegrationService> = new Map();

    static {
        // Register services
        const plService = new PremierLeagueService();
        this.services.set(plService.getLeagueEnum(), plService);
    }
     ...
     */
    static getService(league: RealLifeLeague): ILeagueIntegrationService {
     ...
     */
    static getAllServices(): ILeagueIntegrationService[] {
     ...
     */
    static getAvailableLeagues(): RealLifeLeague[] {
